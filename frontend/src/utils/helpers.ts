...
export function generateVlessURL(config: Config, serverInfo: ServerStatus): string {
...
export function generateVlessJSON(config: Config, serverInfo: ServerStatus): object {
  return {
    v: '2',
